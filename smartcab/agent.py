...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.05):
    ...
    def build_state(self):
        ...
        waypoint = self.planner.next_waypoint() # The next waypoint #Right,left,forward
...
def run():
    ...
    #    * epsilon - continuous value for the exploration factor, default is 1, percent of the time our agent will do random value
